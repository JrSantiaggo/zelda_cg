...
OBJECT_SIZE_X = 0.5   # Metade da largura do sprite (largura total = 1.0 tile)
OBJECT_SIZE_Y = 1.0   # Metade da altura do sprite (altura total = 2.0 tiles)
